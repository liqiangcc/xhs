...
function printHelp() {
    console.log([
        'Usage: node scripts/xhs.js answer <init|init-batch|missing|status|validate|sync|quality-migrate|context|candidate|audit|promote|demote|demote-missing-evidence|human-review> [options]',
        '',
        'Commands:',
